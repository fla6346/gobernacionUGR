 ...
 ::after,::before{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}::after,::before{--tw-content:''}
        ...
        .degrade{background-image:linear-gradient(#3c69b1,#0097a7);
            ...
            .bgNav2{ background-color:#0D47A1 !important; width: 100%;}.bgBorder{width: 20px;height: 70px;}.centro{padding-left:50px }.dividido{width: 100%;}
            .textTitulo{text-align: center;}
            .si{text-align: center; overflow: hidden; border-radius:10px }.pri{padding: 20px;}
            .spantitle{font-size: 32px; text-align: center;}
            .spantitle1{font-size: 25px; text-align: center;}
            .colorWhite{color:white;}
            .tam1{height: none   ;}@media(min-width:700px){.tam1{height: 200px;}}
            .ima{height: 70px;}
            .titulo12{font-size: 25px;}
            .texto1{font-size: 25px;text-align: center;}
            .mta-16{margin-top: 4rem;}
            .dividido2{display: grid;grid-template-columns: repeat(3,1fr);}
            .degrade2{background-image:linear-gradient(#3c69b1,#0097a7);color: white; padding: 40px; height: 160px;}
            .titulo1{font-size: 20px;}
            .image-container { display: inline-block; margin-right: 10px; }.text {display: inline-block; font-size: 18px; /* adjust the font size as needed */}
            .img12{width: 0px; height: 0px;}
            .foot{font-size: 25px; text-align: center; font-weight: 600;color: white;  padding-top: 35px;}
            .foot1{font-size: 20px; text-align: center; color: white}

            @media(min-width:700px){.img2{max-width: 100%;height: auto;}}
            @media(max-width:700px){.titulo,.spantitle{font-size: 12px; text-align: center;}}
            @media(max-width:700px){.centro{padding-left:0; }}
            @media(max-width:700px){.degrade{padding: 0;height: 100px;}}
            @media(max-width:700px){.bgBorder{height: 0;}}
            @media(max-width:700px){.h3{margin:0;}}
            @media(max-width:700px){.dividido1{height: 100%;}}
            @media(max-width:700px){.spantitle1{font-size: 15px}}
            @media(max-width:700px){.titulo12{color: white; font-size: 15px}}
            @media(max-width:700px){.textTitulo{top: 20%; position: relative;}}
            @media(max-width:700px){.texto1{font-size: 15px;}}
            @media(max-width:700px){.mta-16{margin-top:0rem; }}
            @media(max-width:700px){.foot{font-size:15px;}}
            @media(max-width:700px){.foot1{font-size:10px;}}
    </style>
<x-app-layout>
    <div class="flex justify-center degrade dividido1">
        <a class="scale-100 p-6  ">
            <img class="img2 centro" src="{{ asset('img/MarcaDepFi.png') }}">
        </a>
        <a>
            <span class="textTitulo colorWhite">
                <h3 class="spantitle" > CENTRO DE MONITOREO E INFORMACIÓN</h3>
                    <h5 class="titulo12">PARA LA GESTIÓN DE RIESGOS Y DESASTRES</h5>
            </span>
        </a>
        <a class="scale-100 p-6 ">
            <img class="img1 centro" src="{{ asset('img/MarcaGestionFi.png') }}">
        </a>
    </div>
    <div class="mta-16">
        <div class="pri ">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                <a href="" class="scale-100 p-6 degrade1 ">
                    <div >
                ...
                <!--button class="btn btn-primary">cambios al panel 1</!--button-->
